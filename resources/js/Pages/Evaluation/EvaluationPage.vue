    ...
    <AuthenticatedLayout>
        <div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
            <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
                <Card
                    class="overflow-hidden shadow-xl border-t-4 border-indigo-500"
                >
                    <div
                        class="p-6 border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800"
                    >
                        <h1
                        ...
                        <p class="text-sm text-gray-500 mt-1">
                            {{
                                __(
                                    "Please provide your overall feedback to evaluate the employee's performance during their tenure with us"
                                )
                            }}
                        </p>
                    </div>
                    ...
                    >
                        <h3
                            class="text-sm font-bold text-blue-800 dark:text-blue-300 mb-3 uppercase tracking-wider"
                        >
                            {{ __("Rating Scale Definitions") }}
                        </h3>
                        <div class="space-y-2">
                            <div
                                v-for="s in scaleDescriptions"
                                :key="s.val"
                                class="text-sm leading-relaxed"
                            >
                                <span
                                    class="font-bold text-blue-700 dark:text-blue-400"
                                    >{{ s.val }}. {{ __(s.label) }}</span
                                >
                    ...
                    <form @submit.prevent="submitEvaluation" class="p-6">
                        <div
                            class="mb-10 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl"
                        >
                            <InputLabel
                                class="mb-2 text-indigo-700 dark:text-indigo-300 font-semibold"
                                :value="__('Select Employee')"
                            />
                            <select
                            ...
                            <InputError
                                class="mt-2"
                                :message="evaluationForm.errors.employee_id"
                            />
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            >
                                <span
                                    class="w-8 h-8 rounded-full bg-indigo-100 dark:bg-indigo-800 text-indigo-600 dark:text-indigo-200 flex items-center justify-center mr-2 text-sm"
                                    >1</span
                                >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            class="text-xs text-gray-400 uppercase tracking-tighter"
                                            >{{ __("Poor") }}</span
                                        >
                                        <div
                                    ...
                                    <InputError
                                        class="mt-2"
                                        :message="
                                            evaluationForm.errors[item.key]
                                        "
                                    />
                                </div>
                            </div>
                        ...
                        <div class="mt-12 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    <InputLabel :value="__('Strong Points')" />
                                    <textarea
                                        v-model="evaluationForm.strong_points"
                                        ...
                                        placeholder="What did they excel at this month?"
                                    ></textarea>
                                </div>
                                <div class="space-y-2">
                                    <InputLabel :value="__('Weak Points')" />
                                    <textarea
                                        v-model="evaluationForm.weak_points"
                            ...
                            <div class="space-y-2">
                                <InputLabel :value="__('Final Comments')" />
                                <textarea
                                    v-model="evaluationForm.final_comments"
                                    ...
                                    placeholder="Any additional thoughts or summary..."
                                ></textarea>
                            </div>
                        </div>
