        ...
        <div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center mb-8">
                    <Link v-if="$page.props.auth.user.roles.includes('admin')" :href="route('admin.evaluations')"
                        class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-purple-600 transition-colors group">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-4 h-4 mr-1 transform group-hover:-translate-x-1 transition-transform" fill="none"
                    ...
                    <Link v-else :href="route('evaluations.mine')"
                        class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-purple-600 transition-colors group">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-4 h-4 mr-1 transform group-hover:-translate-x-1 transition-transform" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                ...
                <Card class="!p-0 overflow-hidden shadow-xl border-none">
                    <div class="bg-gradient-to-br from-indigo-800 to-slate-700 p-8 border-b border-white/10 shadow-lg">
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                            <div>
                                ...
                                <h2 class="text-4xl font-extrabold text-white tracking-tight italic">
                                    {{ evaluation.employee?.name }}
                                </h2>

                                <p class="text-indigo-200/60 mt-1 font-medium text-sm tracking-wide">
                            ...
                            <div
                                ...
                                <p class="text-[10px] text-indigo-300 uppercase font-black tracking-widest opacity-70">
                                    {{ __("Report Issued") }}
                                </p>
                                <p class="text-xl font-medium text-white font-mono">
                                    {{
                                        new Date(
                    ...
                    <div class="p-8">
                        <div class="flex flex-wrap gap-8 mb-10 pb-8 border-b border-gray-100 dark:border-gray-700">
                            <div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            <div>
                                <h3
                                    ...
                                    <span class="w-8 h-[2px] bg-purple-600 mr-2"></span>
                                    {{ __("Core Performance Metrics") }}
                                </h3>
                                <div class="space-y-5">
                                    <div v-for="metric in performanceMetrics" :key="metric.key" class="group">
                            ...
                            <div>
                                <h3
                                    ...
                                    <span class="w-8 h-[2px] bg-indigo-600 mr-2"></span>
                                    {{ __("Professional Conduct & Skills") }}
                                </h3>
                                <div class="space-y-5">
                                    <div v-for="metric in softSkills" :key="metric.key" class="group">
                                        <div class="flex justify-between mb-2">
                                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{
                                                __(metric.label) }}</span>
                        ...
                        <div class="mt-12 pt-10 border-t border-gray-100 dark:border-gray-700 space-y-8">
                            ...
                            <div v-if="evaluation.final_comments">
                                ...
                                <p class="text-lg text-gray-800 dark:text-gray-200 font-medium leading-relaxed italic">
