        ...
        <div
            ...
            <ul v-if="$page.props.auth.user.roles.includes('admin')" class="space-y-2 font-medium mb-4">
                ...
                <SidebarListItem :item-name="__('Employees')" :hasBadge="true" badge="number"
                    :badge-content="$page.props.ui.empCount.toString() ?? '?'" link="employees.index" :active-links="[
                        'employees.index',
                        'employees.create',
                        'employees.show',
                        'employees.find',
                ...
                <SidebarListItem :item-name="__('Teams')" :hasBadge="false" link="teams.index" :active-links="[
                    'teams.index',
                    'teams.create',
                    'teams.show',
                    'teams.edit',
                ...
                <SidebarListItem :item-name="__('Organization')" :active-links-recursive="[
                    'branches',
                    'departments',
                    'positions',
                    'shifts',
                ...
                <SidebarListItem :item-name="__('Requests')" :hasBadge="$page.props.ui.reqCount.toString() !== '0'"
                    badge="number" :badge-content="$page.props.ui.reqCount.toString() ?? '?'" link="requests.index"
                    :active-links="[
                        'requests.index',
                        'requests.create',
                        'requests.show',
                ...
                <SidebarListItem :item-name="__('Calendar')" link="calendar.index" :activeLinks="[
                    'calendar.index',
                    'calendars.index',
                    'calendars.create',
                    'calendars.show',
                ...
                <SidebarListItem :item-name="__('Attendance')" link="attendances.index" :activeLinks="[
                ...
                <SidebarListItem :item-name="__('Payrolls')" link="payrolls.index" :activeLinks="[
                    'payrolls.index',
                    'payrolls.show',
                    'payrolls.edit',
                ]">
                ...
                <SidebarListItem :item-name="__('Employee Evaluation')" :hasBadge="false" link="evaluations.form"
                    :active-links="['evaluations.form']">
                    <UserIcon class="text-gray-500 dark:text-gray-100" />
                </SidebarListItem>
                <SidebarListItem :item-name="__('All Peer Feedback ')" :hasBadge="false"
                    link="admin.peer-feedback.index" :active-links="['admin.peer-feedback.index']">
                    <UserIcon class="text-gray-500 dark:text-gray-100" />
                </SidebarListItem>
                <SidebarListItem :item-name="__('All Evaluations')" :hasBadge="false" link="admin.evaluations"
            ...
            <ul v-else class="space-y-2 font-medium mb-4">
                ...
                <SidebarListItem :item-name="__('My Profile')" :hasBadge="false" link="my-profile"
                ...
                <SidebarListItem :item-name="__('My Payrolls')" link="payrolls.index"
                    :active-links="['payrolls.index', 'payrolls.show']">
                    <MoneyIcon class="text-gray-500 dark:text-gray-100" />
                </SidebarListItem>

                <SidebarListItem :item-name="__('My Calendar')" link="calendar.index"
                ...
                <SidebarListItem v-if="
                    $page.props.auth.user.roles.includes('team lead') ||
                    $page.props.auth.user.roles.includes('admin')
                " :item-name="__('Employee Evaluation')" :hasBadge="false" link="evaluations.form"
                    :active-links="['evaluations.form']">
                    <UserIcon class="text-gray-500 dark:text-gray-100" />
                </SidebarListItem>
                        ...
                        <div class="flex justify-between h-16">
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                ...
                                <button @click="toggleDark()" type="button"
                                    ...
                                    <svg id="theme-toggle-dark-icon" class="w-5 h-5"
                                        :class="isDark ? 'block' : 'hidden'" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z">
                                        </path>
                                    </svg>
                                    <svg id="theme-toggle-light-icon" class="w-5 h-5"
                                        :class="isDark ? 'hidden' : 'block'" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <div class="relative">
                                    <button @click="open = !open" class="relative p-2 rounded hover:bg-gray-100">
                                        <!-- bell svg -->
                                    ...
                                    <div v-if="open"
                                        class="absolute right-0 mt-2 w-96 bg-white shadow-lg rounded p-2 z-50">
                                        <div v-if="notifications.length === 0"
                                            class="p-4 text-center text-sm text-gray-600">
                                            No notifications
                                        </div>
                                        <div v-for="n in notifications" :key="n.id" @click="openNotification(n)"
                                            class="border-b last:border-b-0 py-2 cursor-pointer hover:bg-gray-100">
                                            <div
                                                class="w-full text-left px-3 py-2 flex items-start gap-3 hover:bg-gray-50">
                                                <div class="flex-1">
                                                ...
                                                <div class="pl-2">
                                                    <div v-if="!n.read" class="text-xs text-blue-600">
                                                        New
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <template #trigger>
                                            <span class="inline-flex rounded-md">
                                                <button type="button"
                                                    ...
                                                    <svg class="mx-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg"
